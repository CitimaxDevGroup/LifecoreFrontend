    ...
    <div className="bg-white">
      <section className="relative bg-gradient-to-r from-blue-50 to-green-50 py-20">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mb-5 mx-auto">
        ...
        <div
          ...
          style={{ clipPath: "polygon(100%, 100% 100%, 100%)" }}
        />
      </section>

      <div
        ref={fadeRef}
        className={`transform transition-all duration-1000 ease-in-out px-4 flex flex-col md:flex-row items-center md:items-start justify-center gap-0 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
      >
        <div className="w-full md:w-[500px] h-[300px] rounded-l-lg overflow-hidden">
          <iframe
        ...
        <div className="w-full md:w-[500px] min-h-[300px] bg-[#f5f5f5] text-black p-8 text-base leading-relaxed text-justify rounded-r-lg flex flex-col items-start justify-start">
          <img
